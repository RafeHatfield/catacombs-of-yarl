...
PAIRS = [
    ("held_vs_unheld_A", "boundA_lit.png", "ctrlA_lit.png",
     "HELD vs UNHELD - native top plane",
     "boundA: MOCK straps, pins, cramps, lashing, one tag",
     "ctrlA: the same stones, overlays omitted"),
    ("held_vs_unheld_B", "boundB_lit.png", "ctrlB_lit.png",
     "HELD vs UNHELD - value-matched top plane",
     "boundB: MOCK straps, pins, cramps, lashing, one tag",
     "ctrlB: the same stones, overlays omitted"),
    ("top_plane_A_vs_B", "boundA_lit.png", "boundB_lit.png",
     "TOP PLANE - native part value vs derivation",
     "boundA: R4 slab at its own value (lum 125, floor is 122)",
     "boundB: R4 slab matched to the face (lum 96)"),
    ("lit_vs_unlit_B", "boundB_lit.png", "boundB_unlit.png",
     "THE SAME TILES, LIT AND UNLIT (bible §6.3)",
     "carried light on - energy 1.6",
     "ambient only - energy 0, nothing else changed"),
    ("solofloor_pair", "boundB_solofloor_lit.png", "ctrlB_solofloor_lit.png",
     "HELD vs UNHELD - floor held to one survivor (A-VAB)",
     "boundB, single-survivor floor",
     "ctrlB, single-survivor floor"),
]
