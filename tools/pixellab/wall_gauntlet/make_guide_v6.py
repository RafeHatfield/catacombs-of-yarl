#!/usr/bin/env python3
"""Guide v6 — per-tile variation. Still geometry only, still not an asset or a palette. NOT an asset, NOT a palette, never shown to the critic.
...
def main():
    ...
    for i in range(n):
        build(130130 + i).save(os.path.join(OUT, "guide_%02d.png" % i))
